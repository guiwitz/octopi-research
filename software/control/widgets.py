...
# qt libraries
from qtpy.QtWidgets import (QMainWindow, QGroupBox, QVBoxLayout,
                            QScrollArea, QWidget, QComboBox, QFileDialog,
                            QPushButton, QCheckBox, QLabel, QGridLayout,
                            QDoubleSpinBox, QSpinBox, QHBoxLayout, QMessageBox,
                            QFrame, QSlider, QDialog, QLineEdit,
...
class MultiPointWidget2(QFrame):
    def __init__(self, navigationController, navigationViewer,
                 multipointController, configurationManager = None,
                 main=None, scanCoordinates=None, *args, **kwargs):
        super().__init__(*args, **kwargs)
    ...
    def load_last_used_locations(self):
        ...
        for row, row_ind in zip(self.last_used_locations, self.last_used_location_ids):
            ...
            if not np.any(np.all(self.location_list[:, :2] == [x, y], axis=1)):
                ...
                self.table_location_list.setItem(self.table_location_list.rowCount()-1,2, QTableWidgetItem(str(round(z,1))))
    ...
    def correct_location(self):
        ...
        for index in range(self.location_list.shape[0]):
            ...
            self.table_location_list.setItem(index,2, QTableWidgetItem(str(round(self.location_list[index,2],1))))
